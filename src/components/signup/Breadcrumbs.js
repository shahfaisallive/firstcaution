...
const Breadcrumbs = ({ level, content }) => {
    return (
                ...
                <div className="collapse navbar-collapse justify-content-start" id="navbarNav">
                    <ul className="navbar-nav mt-3 ml-2">
                        <li className="nav-item d-flex">
                            ...
                            <p className='text1'>{content.introduction}</p>
                        </li>
                        <li className="nav-item d-flex">
                            ...
                            <p className='text1'>{content.your_information}</p>
                        </li>
                        <li className="nav-item d-flex">
                            ...
                            <p className='text1'>{content.guarantee}</p>
                        </li>
                        <li className="nav-item d-flex">
                            ...
                            <p className='text1'>{content.confirmation}</p>
                        </li>
                        {/* <li className="nav-item d-flex">
                            ...
                            <p className='text1'>{content.payment}</p>
                        </li> */}
